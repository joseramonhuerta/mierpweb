...
class ReporteVentasProductosCostosPDF extends FPDF{
	var $cerrando=false;
	var $colorHeader;
	...
	function ReporteVentasProductosCostosPDF($orientation='L',$unit='mm',$format='Letter',$datos,$formatos){
	...
	function imprimeHeader(){
		...
		if ($this->imprimirHeader==true){
			...
			$this->Cell(25,5,utf8_decode("CODIGO BARRAS"),$border,0,"C",$fill);	
			$this->Cell(70,5,utf8_decode("PRODUCTO"),$border,0,"C",$fill);		//------Header
			$this->Cell(48,5,utf8_decode("LINEA"),$border,0,"C",$fill);
			$this->Cell(20,5,utf8_decode("CANT"),$border,0,"C",$fill);				
	...
	public function imprimeDetalles($datos){
		...
		foreach($datos['detalles'] as $dato){	
			...
			$this->Cell(25,$heightCell,utf8_decode($CodigoBarras),$border,$saltoDeLinea,'',$fill);				
			$this->Cell(70,$heightCell,utf8_decode($Descripcion),$border,$saltoDeLinea,'',$fill);
			$this->Cell(48,$heightCell,utf8_decode($NombreLinea),$border,$saltoDeLinea,'',$fill);	
			$this->Cell(20,$heightCell,utf8_decode($Cantidad),$border,$saltoDeLinea,'R',$fill);
