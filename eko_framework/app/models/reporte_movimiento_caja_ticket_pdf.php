...
class ReporteMovimientoCajaTicketPDF extends PDF_JavaScript{
	var $cerrando=false;
	var $colorHeader;
	...
	function ReporteMovimientoCajaTicketPDF($orientation='L',$unit='mm',$format='Letter',$datos,$formatos){
	...
	public function Header() {
		...
		$fecha_turno=$datos['movimientocaja']['fecha'];		
		$concepto=$datos['movimientocaja']['concepto'];
		$consecutivo=$datos['movimientocaja']['consecutivo'];
		$tipo=$datos['movimientocaja']['tipo'];
		...
		$this->Ln();
		$this->SetX(2);
		$this->Cell(80,$hCell,mb_strtoupper(UTF8_decode("MOVIMIENTO CAJA")),$border,0,'L');	#	Valor
		$this->Ln();
		$this->SetX(2);
		...
		$this->Ln();
		$this->SetX(2);
		$this->Cell(80,$hCell,"CONSECUTIVO: ".mb_strtoupper(UTF8_decode($consecutivo)),$border,0,'L');	#	Valor	
		$this->Ln();
		$this->SetX(2);
		$this->Cell(80,$hCell,"TIPO: ".mb_strtoupper(UTF8_decode($tipo)),$border,0,'L');	#	Valor	
		$this->Ln();
		$this->SetX(2);
	...
	function imprimirTotales($ultimo=false){
		...
		$total = number_format ($datos['movimientocaja']['total'] ,$decimales ,  '.' , ',' );
