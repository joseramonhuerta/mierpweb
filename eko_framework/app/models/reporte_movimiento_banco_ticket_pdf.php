...
class ReporteMovimientoBancoTicketPDF extends PDF_JavaScript{
	var $cerrando=false;
	var $colorHeader;
	...
	function ReporteMovimientoBancoTicketPDF($orientation='L',$unit='mm',$format='Letter',$datos,$formatos){
	...
	public function Header() {
		...
		$origen=$datos['movimientobanco']['origen'];
		$serie=$datos['movimientobanco']['serie'];
		$folio=$datos['movimientobanco']['folio'];
		$nombre_cliente=$datos['movimientobanco']['nombre_cliente'];
		$fecha_turno=$datos['movimientobanco']['fecha'];		
		$concepto=$datos['movimientobanco']['concepto'];
		$chequera=$datos['movimientobanco']['chequera'];
		$tipo_movimiento=$datos['movimientobanco']['tipo_movimiento'];
		$tipo_origen=$datos['movimientobanco']['tipo_origen'];
		$observaciones=$datos['movimientobanco']['observaciones'];
		//----------------------------------------------------
		//			Titulo del reporte
		//----------------------------------------------------
		...
		$this->Ln();
		$this->SetX(2);
		$this->Cell(80,$hCell,mb_strtoupper(UTF8_decode($origen)),$border,0,'L');	#	Valor
		$this->Ln();
		$this->SetX(2);
		...
		$this->Ln();
		$this->SetX(2);
		$this->Cell(80,$hCell,mb_strtoupper(UTF8_decode($tipo_movimiento)),$border,0,'L');	#	Valor	
		$this->Ln();
		$this->SetX(2);
		$this->Cell(80,$hCell,mb_strtoupper(UTF8_decode($concepto)),$border,0,'L');	#	Valor
		$this->Ln();
		$this->SetX(2);
		$this->Cell(80,$hCell,mb_strtoupper(UTF8_decode($tipo_origen))." ".mb_strtoupper(UTF8_decode($chequera)),$border,0,'L');	#	Valor	
		$this->Ln();
		$this->SetX(2);
		$this->Cell(80,$hCell,mb_strtoupper(UTF8_decode($observaciones)),$border,0,'L');	#	Valor	
		#	Label
		$this->SetFont($font,'',7);						
		$this->Ln();
		$this->SetX(0);		
	...
	function imprimirTotales($ultimo=false){
		...
		$total = number_format ($datos['movimientobanco']['importe'] ,$decimales ,  '.' , ',' );
