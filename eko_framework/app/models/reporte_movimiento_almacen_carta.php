 ...
 */
class ReporteMovimientoAlmacenCarta{
	...
	function crearReporte($datos,$formatos){
		...
		require "eko_framework/app/models/reporte_movimiento_almacen_carta_pdf.php";
		
		$pdf=new ReporteMovimientoAlmacenCartaPDF('P','mm','Letter',$datos,$formatos);
		// --------------------------------------------------------------------------------------------------------
		$pdf->AddPage('P');
	...
	function obtenerDatos($params){
		...
		m.importe,m.descuento,m.subtotal,m.impuestos,m.total,t.nombre_movimiento,t.tipo_movimiento,e.nombre_fiscal,s.nombre_sucursal,IFNULL(a1.nombre_almacen,'') as almacen_origen,IFNULL(a2.nombre_almacen,'') as almacen_destino,
