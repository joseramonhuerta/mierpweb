...
class ReporteClientesCategoriasPDF extends FPDF{
	var $cerrando=false;
	var $colorHeader;
	...
	function ReporteClientesCategoriasPDF($orientation='L',$unit='mm',$format='Letter',$datos,$formatos){
	...
	public function Header() {
		...
		$nombre_categoria=$datos['filtros']['nombre_categoria'];
		...
		$this->Cell(100,10,utf8_decode("Reporte Catalogo Clientes Categorias"),0,0,'L');	
		$this->SetX(108);
		...
		$this->Cell(20,$hCell,"CATEGORIA: ",$border,0,'L');	#	Valor
		$this->SetFont($font,'',9);
		$this->Cell(80,$hCell,mb_strtoupper(UTF8_decode($nombre_categoria)),$border,0,'L');	#	Valor
	...
	function imprimeHeader(){
		...
		if ($this->imprimirHeader==true){
			...
			$this->Cell(40,5,utf8_decode("RAZON SOCIAL"),$border,0,"C",$fill);		//------Header 
			$this->Cell(40,5,utf8_decode("NOMBRE COMERCIAL"),$border,0,"C",$fill);	
			$this->Cell(60,5,utf8_decode("DIRECCION"),$border,0,"C",$fill);		//------Header
			$this->Cell(15,5,utf8_decode("TELEFONO"),$border,0,"C",$fill);
			$this->Cell(15,5,utf8_decode("CELULAR"),$border,0,"C",$fill);				
			$this->Cell(28,5,utf8_decode("CATEGORIA"),$border,0,"C",$fill);	
	...
	public function imprimeDetalles($datos){
		...
		foreach($datos['clientes'] as $dato){	
			...
			$nombre_fiscal = $dato['nombre_fiscal'];
			$nombre_comercial = $dato['nombre_comercial'];			
			$direccion = $dato['direccion'];
			$telefono_contacto = $dato['telefono_contacto'];
			$celular_contacto = $dato['celular_contacto'];
			$nombre_categoria = $dato['nombre_categoria'];			
									
			$this->Cell(40,$heightCell,utf8_decode($nombre_fiscal),$border,$saltoDeLinea,'',$fill);
			$this->Cell(40,$heightCell,utf8_decode($nombre_comercial),$border,$saltoDeLinea,'',$fill);				
			$this->Cell(60,$heightCell,utf8_decode($direccion),$border,$saltoDeLinea,'',$fill);
			$this->Cell(15,$heightCell,utf8_decode($telefono_contacto),$border,$saltoDeLinea,'',$fill);
			$this->Cell(15,$heightCell,utf8_decode($celular_contacto),$border,$saltoDeLinea,'',$fill);
			$this->Cell(28,$heightCell,utf8_decode($nombre_categoria),$border,$saltoDeLinea,'',$fill);
