<?php
class ChequeraModel extends Model{
    var $useTable = 'cat_chequeras';
    var $name='Chequera';
    var $primaryKey = 'id_chequera';
    var $specific = true;
	...
	function readAll($start, $limit, $filtro, $filtroStatus) {
        ...
        $query = "SELECT id_chequera,descripcion,
				status FROM $this->useTable
	...
	function getById($id){
    	...
    	return array('Chequera'=>$arrResult[0]);
    }
