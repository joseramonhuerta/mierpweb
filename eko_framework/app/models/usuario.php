...
class UsuarioModel extends Model{
    ...
    var $specific = true;
    var $camposAfiltrar = array('nombre_usuario');
	...
	function readAll($start, $limit, $filtro, $filtroStatus) {
        ...
        $query = "SELECT id_usuario,nombre_usuario, usuario,status FROM $this->useTable
				  $filtroSql ORDER BY nombre_usuario limit $start,$limit ;";
