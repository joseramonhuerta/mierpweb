...
class KardexDeMovimientosPDF extends TCPDF {
	...
	function imprimir($path,$mode='I',$params){	
		...
		//----------------------------------------------------------------------------------------
		//	Se obtienen los detalles de cada producto y la suma de entradas y salidas por almac�n
		//----------------------------------------------------------------------------------------		
		...
		//Estos registros se usar�n para obtener los datos del ultimo saldo, ultimos costos, etc.		
