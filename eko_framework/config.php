...
define("PAIS_NOMBRE",			 'M�XICO');	
define("CIUDAD_ID",				 1883);		//	Ciudad de la tabla cat_ciudades
define("CIUDAD_NOMBRE",			 'MAZATL�N');	
...
//========    INVENTARIOS    ===========//
/*
if ( empty($_SESSION['Auth']['User']['ManejaInvEmp']) ){
	define("INVENTARIAR_VENTAS",    false);
	define("INVENTARIAR_FACTURAS",  false);
}else{	
	define("INVENTARIAR_VENTAS",    TRUE);
	define("INVENTARIAR_FACTURAS",  TRUE);
}*/
