...
cerrar:function(milisegundos){    
    setTimeout("Sexy.display(0)",milisegundos);
},
    messageBox: function(type, message, properties, input) {
        ...
        if(type == 'alert' || type == 'info' || type == 'error'||type=='errorAutoClose')
        {
            ...
            if (properties.autoClose==true){
                setTimeout("Sexy.display(0)",properties.milisegundos);
                //this.cerrar(properties.milisegundos);
            }
