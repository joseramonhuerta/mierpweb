...
winBuscadorProductos = Ext.extend(winBuscadorProductosUi, {
	inicializarStores:function(){
			this.gridProductos.store=new miErpWeb.winBuscadorProductosStore();
	},
	...
	initComponent: function() {
        winBuscadorProductos.superclass.initComponent.call(this);
		this.inicializarStores();
		this.inicializarEvents();
    }
});
Ext.reg('winBuscadorProductos', winBuscadorProductos);