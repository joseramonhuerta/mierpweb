...
formPuntoVentaWinProductos = Ext.extend(formPuntoVentaWinProductosUi, {
	inicializarStores:function(){
			this.gridProductos.store=new miErpWeb.storePuntoVentaWinProductos();
	},
	...
	initComponent: function() {
        formPuntoVentaWinProductos.superclass.initComponent.call(this);
		this.inicializarStores();
		this.inicializarEvents();
    }
});
Ext.reg('formPuntoVentaWinProductos', formPuntoVentaWinProductos);