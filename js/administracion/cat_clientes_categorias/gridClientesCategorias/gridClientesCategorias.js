/*
 * File: gridClientesCategorias.js
...
Ext.ns('miErpWeb');
Ext.ns('mew');
gridClientesCategorias = Ext.extend(gridClientesCategoriasUi, {
	...
	inicializarStores:function(){
			this.store=new miErpWeb.storeGridClientesCategorias();
			this.bottomToolbar.bindStore(this.store);
			  
			this.cmbStatus.store = new miErpWeb.storeGridClientesCategoriasStatus();        
			var data=new Array(
    ...
    initComponent: function() {
        ...
        gridClientesCategorias.superclass.initComponent.call(this);
	...
	editar:function(id){
    	...
    	var params={            
           xtype:'formClientesCategorias',           
           idValue:id,           
           title:'Editar Categoria de Cliente',
           iconMaster:this.iconMaster,
			closable: true,		   
	...
	eliminar:function(btn,id){
		...
		Ext.Ajax.request({
			params: { id_cliente_categoria: id },
			scope:this,
...
Ext.reg('gridClientesCategorias', gridClientesCategorias);