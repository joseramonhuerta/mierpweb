...
Ext.ns('miErpWeb');
Ext.ns('mew');
gridChequeras = Ext.extend(gridChequerasUi, {
	...
	inicializarStores:function(){
			this.store=new miErpWeb.storeGridChequeras();
			this.bottomToolbar.bindStore(this.store);
			  
			this.cmbStatus.store = new miErpWeb.storeGridChequerasStatus();        
			var data=new Array(
    ...
    initComponent: function() {
        ...
        gridChequeras.superclass.initComponent.call(this);
...
Ext.reg('gridChequeras', gridChequeras);