...
Ext.ns('miErpWeb');
Ext.ns('mew');
gridInventarios = Ext.extend(gridInventariosUi, {
	renderAplicado:function(val,x,rec){
		var value = '';
		if(val==0)
	...
	inicializarRenders:function(){
		...
		var columna=colModel.getColumnById('colAplicado');
	...
	inicializarStores:function(){
			this.store=new miErpWeb.storeGridInventarios();
			this.bottomToolbar.bindStore(this.store);
				
			this.cmbStatus.store = new miErpWeb.storeGridInventariosStatus();        
			var data=new Array(
    ...
    initComponent: function() {
        gridInventarios.superclass.initComponent.call(this);
	...
	eliminar:function(btn,id){
    	...
    	default:
    		...
    		Ext.Msg.show({
 			   ...
 			   msg: "¿Desea borrar el Inventario?",
		...
		Ext.Ajax.request({
			params: { id_inventario: id },
			scope:this,
		   	url: 'app.php/inventarios/eliminar',
...
Ext.reg('gridInventarios', gridInventarios);