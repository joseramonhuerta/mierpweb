...
Ext.ns('miErpWeb');
Ext.ns('mew');
gridRemisiones = Ext.extend(gridRemisionesUi, {
	...
	inicializarStores:function(){
			this.store=new miErpWeb.storeGridRemisiones();
			this.bottomToolbar.bindStore(this.store);
				
			this.cmbStatus.store = new miErpWeb.storeGridRemisionesStatus();        
			var data=new Array(
    ...
    initComponent: function() {
        gridRemisiones.superclass.initComponent.call(this);
...
Ext.reg('gridRemisiones', gridRemisiones);