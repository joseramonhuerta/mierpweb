...
Ext.ns('miErpWeb');
Ext.ns('mew');
gridListaPrecios = Ext.extend(gridListaPreciosUi, {	
	...
	inicializarStores:function(){
			this.store=new miErpWeb.storeGridListaPrecios();
			this.bottomToolbar.bindStore(this.store);
				
			this.cmbStatus.store = new miErpWeb.storeGridListaPreciosStatus();        
			var data=new Array(
    ...
    initComponent: function() {
        gridListaPrecios.superclass.initComponent.call(this);
...
Ext.reg('gridListaPrecios', gridListaPrecios);