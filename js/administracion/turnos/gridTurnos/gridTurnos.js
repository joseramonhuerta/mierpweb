/*
 * File: gridTurnos.js
 * Date: Sun Oct 29 2017 18:35:59 GMT-0700 (Hora estándar Montañas (México))
 * 
...
Ext.ns('miErpWeb');
Ext.ns('mew');
gridTurnos = Ext.extend(gridTurnosUi, {
	...
	inicializarStores:function(){
			this.store=new miErpWeb.storeGridTurnos();
			this.bottomToolbar.bindStore(this.store);
				
			this.cmbStatus.store = new miErpWeb.storeGridTurnosStatus();        
			var data=new Array(
    ...
    initComponent: function() {
        gridTurnos.superclass.initComponent.call(this);
