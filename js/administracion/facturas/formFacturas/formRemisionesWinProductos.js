/*
 * File: formRemisionesWinProductos.js
...
formRemisionesWinProductos = Ext.extend(formRemisionesWinProductosUi, {
	inicializarStores:function(){
			this.gridProductos.store=new miErpWeb.storeFormRemisionesWinProductos();
	},
	...
	initComponent: function() {
        formRemisionesWinProductos.superclass.initComponent.call(this);
		this.inicializarStores();
		this.inicializarEvents();
    }
});
Ext.reg('formRemisionesWinProductos', formRemisionesWinProductos);