...
Ext.ns('miErpWeb');
Ext.ns('mew');
gridGastos = Ext.extend(gridGastosUi, {
	...
	inicializarStores:function(){
			this.store=new miErpWeb.storeGridGastos();
			this.bottomToolbar.bindStore(this.store);
				
			this.cmbStatus.store = new miErpWeb.storeGridGastosStatus();        
			var data=new Array(
    ...
    initComponent: function() {
        gridGastos.superclass.initComponent.call(this);
