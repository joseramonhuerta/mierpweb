/*
 * File: gridMovimientosAlmacen.js
...
Ext.ns('miErpWeb');
Ext.ns('mew');
gridMovimientosAlmacen = Ext.extend(gridMovimientosAlmacenUi, {
	...
	inicializarStores:function(){
			this.store=new miErpWeb.storeGridMovimientosAlmacen();
			this.bottomToolbar.bindStore(this.store);
				
			this.cmbStatus.store = new miErpWeb.storeGridMovimientosAlmacenStatus();        
			var data=new Array(
    ...
    initComponent: function() {
        gridMovimientosAlmacen.superclass.initComponent.call(this);
    ...
    nuevo:function(){
    	var params={            
           xtype:'formMovimientosAlmacen',           
           idValue:0,
           title:'Nuevo Movimiento Almacen',
		   closable: true,
	...
	editar:function(id){
    	...
    	var params={            
           xtype:'formMovimientosAlmacen',           
           idValue:id,           
           title:'Editar Movimiento Almacen',
           iconMaster:this.iconMaster,
			closable: true,		   
...
Ext.reg('gridMovimientosAlmacen', gridMovimientosAlmacen);