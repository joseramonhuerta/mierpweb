...
Ext.ns('miErpWeb');
Ext.ns('mew');
gridEmpleados = Ext.extend(gridEmpleadosUi, {
	...
	inicializarStores:function(){
			this.store=new miErpWeb.storeGridEmpleados();
			this.bottomToolbar.bindStore(this.store);
			  
			this.cmbStatus.store = new miErpWeb.storeGridEmpleadosStatus();        
			var data=new Array(
    ...
    initComponent: function() {
        ...
        gridEmpleados.superclass.initComponent.call(this);
...
Ext.reg('gridEmpleados', gridEmpleados);