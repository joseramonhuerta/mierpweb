/*
 * File: formReporteAbonosClientes.js
...
Ext.ns('miErpWeb');
Ext.ns('mew');
formReporteAbonosClientes = Ext.extend(formReporteAbonosClientesUi, {
	inicializarStores: function(){
		this.cmbAgente.store =  new miErpWeb.storeFormReporteAbonosClientesAgentes();
		
		this.cmbCliente.store =  new miErpWeb.storeFormReporteAbonosClientes();
	},
    ...
    initComponent: function() {
        formReporteAbonosClientes.superclass.initComponent.call(this);
	...
	imprimir:function(){
		...
		Ext.Ajax.request({
		params: params,
		   url: 'app.php/abonos/generarreporteabonos',
		   success: function(response, opts){
				...
				window.open("app.php/abonos/getpdfreporteabonos?identificador="+identificador,'rep_mov',"height=600,width=800");							
			},
		   failure: function(){
...
Ext.reg('formReporteAbonosClientes', formReporteAbonosClientes);