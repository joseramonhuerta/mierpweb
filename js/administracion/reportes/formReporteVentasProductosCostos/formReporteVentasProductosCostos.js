/*
 * File: formReporteVentasProductosCostos.js
...
Ext.ns('miErpWeb');
Ext.ns('mew');
formReporteVentasProductosCostos = Ext.extend(formReporteVentasProductosCostosUi, {
    inicializarStores: function(){
		this.cmbLinea.store =  new miErpWeb.storeFormReporteVentasProductosCostosLineas();
		this.cmbSucursal.store =  new miErpWeb.storeFormReporteVentasProductosCostosSucursales();
	},
	...
	initComponent: function() {
        formReporteVentasProductosCostos.superclass.initComponent.call(this);
	...
	imprimir:function(){
		...
		Ext.Ajax.request({
		params: params,
		   url: 'app.php/ventas/generarreporteventasproductoscostos',
		   success: function(response, opts){
				...
				window.open("app.php/ventas/getpdfventasproductoscostos?identificador="+identificador,'rep_mov',"height=600,width=800");							
			},
		   failure: function(){
...
Ext.reg('formReporteVentasProductosCostos', formReporteVentasProductosCostos);