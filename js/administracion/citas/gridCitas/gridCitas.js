...
Ext.ns('miErpWeb');
Ext.ns('mew');
gridCitas = Ext.extend(gridCitasUi, {
	...
	inicializarStores:function(){
			this.store=new miErpWeb.storeGridCitas();
			this.bottomToolbar.bindStore(this.store);
				
			this.cmbStatus.store = new miErpWeb.storeGridCitasStatus();        
			var data=new Array(
    ...
    initComponent: function() {
        gridCitas.superclass.initComponent.call(this);
