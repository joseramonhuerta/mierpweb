/*
 * File: gridMovimientosCaja.js
 * Date: Sun Nov 12 2017 13:14:44 GMT-0700 (Hora estándar Montañas (México))
 * 
...
Ext.ns('miErpWeb');
Ext.ns('mew');
gridMovimientosCaja = Ext.extend(gridMovimientosCajaUi, {
	...
	inicializarStores:function(){
			this.store=new miErpWeb.storeGridMovimientosCaja();
			this.bottomToolbar.bindStore(this.store);
				
			this.cmbStatus.store = new miErpWeb.storeGridMovimientosCajaStatus();        
			var data=new Array(
    ...
    initComponent: function() {
        gridMovimientosCaja.superclass.initComponent.call(this);
	...
	nuevo:function(){
    	var params={            
           xtype:'formMovimientosCaja',       
           idValue:0,
           title:'Nuevo Movimientos de Caja',
		   closable: true,
	...
	eliminar:function(btn,id){
    	...
    	default:
    		...
    		Ext.Msg.show({
 			   ...
 			   msg: "¿Desea borrar el Movimiento de Caja?",
		...
		Ext.Ajax.request({
			params: { id_movimiento_caja: id },
			scope:this,
		   	url: 'app.php/movimientoscaja/eliminar',
...
Ext.reg('gridMovimientosCaja', gridMovimientosCaja);