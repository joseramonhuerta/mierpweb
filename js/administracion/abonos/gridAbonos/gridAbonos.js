...
Ext.ns('miErpWeb');
Ext.ns('mew');
gridAbonos = Ext.extend(gridAbonosUi, {
	...
	inicializarStores:function(){
			this.store=new miErpWeb.storeGridAbonos();
			this.bottomToolbar.bindStore(this.store);
				
			this.cmbStatus.store = new miErpWeb.storeGridAbonosStatus();        
			var data=new Array(
    ...
    initComponent: function() {
        gridAbonos.superclass.initComponent.call(this);
