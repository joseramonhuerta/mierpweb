...
Ext.ns('miErpWeb');
Ext.ns('mew');
gridCotizaciones = Ext.extend(gridCotizacionesUi, {
	...
	inicializarStores:function(){
			this.store=new miErpWeb.storeGridCotizaciones();
			this.bottomToolbar.bindStore(this.store);
				
			this.cmbStatus.store = new miErpWeb.storeGridCotizacionesStatus();        
			var data=new Array(
    ...
    initComponent: function() {
        gridCotizaciones.superclass.initComponent.call(this);
...
Ext.reg('gridCotizaciones', gridCotizaciones);