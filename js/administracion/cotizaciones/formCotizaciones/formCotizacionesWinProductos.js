/*
 * File: formCotizacionesWinProductos.js
...
formCotizacionesWinProductos = Ext.extend(formCotizacionesWinProductosUi, {
	inicializarStores:function(){
			this.gridProductos.store=new miErpWeb.storeFormCotizacionesWinProductos();
	},
	...
	initComponent: function() {
        formCotizacionesWinProductos.superclass.initComponent.call(this);
		this.inicializarStores();
		this.inicializarEvents();
    }
});
Ext.reg('formCotizacionesWinProductos', formCotizacionesWinProductos);