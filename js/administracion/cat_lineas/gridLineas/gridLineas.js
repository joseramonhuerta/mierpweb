...
Ext.ns('miErpWeb');
Ext.ns('mew');
gridLineas = Ext.extend(gridLineasUi, {
	...
	inicializarStores:function(){
			this.store=new miErpWeb.storeGridLineas();
			this.bottomToolbar.bindStore(this.store);
			  
			this.cmbStatus.store = new miErpWeb.storeGridLineasStatus();        
			var data=new Array(
    ...
    initComponent: function() {
        ...
        gridLineas.superclass.initComponent.call(this);
